...
public class Main {
    public static void main(String[] args) {
        ...
        Course cs101 = new Course.Builder("CS101", "Introduction to Programming")
            .credits(3).instructor("Dr. Smith").semester(Semester.SPRING).department("Computer Science").build();
        
        Course math201 = new Course.Builder("MATH201", "Calculus I")
            .credits(4).instructor("Dr. Johnson").semester(Semester.SPRING).department("Mathematics").build();
        
        Course phys101 = new Course.Builder("PHYS101", "Physics I")
            .credits(4).instructor("Dr. Brown").semester(Semester.SPRING).department("Physics").build();
